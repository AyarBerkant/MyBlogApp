...
using MyBlogApp.Shared.Utilities.Results.Concrete;

namespace MyBlogApp.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IResult> Update(CategoryUpdateDto categoryUpdateDto, string modifiedByName)
        {
            ...
            await _unitOfWork.SaveAsync();
            return new Result(ResultStatus.Success, $"{categoryUpdateDto.Name} adlı kategori başarıyla güncellenmistir.");
        }
